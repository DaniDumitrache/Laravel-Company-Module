...
@section('content')
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="first_name" type="text" class="form-control" name="first_name"
                                            value="{{ $employee->first_name }}" required autocomplete="first_name"
                                            autofocus>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input id="last_name" type="text" class="form-control" name="last_name"
                                            value="{{ $employee->last_name }}" required autocomplete="last_name" autofocus>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
    ...
    <script>
        $('#create').click(function(e) {
            ...
            axios({
                method: "POST",
                url: "{{ route('api.employees.edit', $id) }}",
                params: params,
            }).then((res) => {
